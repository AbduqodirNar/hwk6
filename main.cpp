...
using namespace std;
int globalNum;
string mostFrequentString(const string& str1, const string& str2, char character,
bool& sameTimes) {
...
int main() {
 ...
 cout << "The string \"" << result << "\" contains the character '" << character
<< "' most times (" << count << " times)." << endl;
 }
 cout<< "Problem_3" << endl;
 string input;
 int numDigits;
 ...
 cout << "Problem_4" << endl;
 int choice;
 std::cout << "Enter 1 to find the largest sum pair or 2 to find the min and max of
an array: ";
 std::cin >> choice;
 switch (choice) {
 case 1: {
